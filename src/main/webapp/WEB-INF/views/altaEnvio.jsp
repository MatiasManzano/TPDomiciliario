...
<%--     <form:form method="POST" modelAttribute="envio" class="form-horizontal"> --%>
...
<!--                 <div class="col-md-7"> -->
<%--                     <form:input type="text" path="remitente" id="remitente" class="form-control input-sm" /> --%>
<!--                     <div class="has-error"> -->
...
<!--         <div class="row"> -->
<!--             <div class="form-group col-md-12"> -->
<!--                 <label class="col-md-3 control-lable" for="piso">Calle</label> -->
<!--                 <div class="col-md-7"> -->
...
<!--         <div class="row"> -->
<!--             <div class="form-group col-md-12"> -->
<!--                 <label class="col-md-3 control-lable" for="piso">Numero</label> -->
<!--                 <div class="col-md-7"> -->
<%--                     <form:input type="text" path="piso" id="piso" class="form-control input-sm"/> --%>
<!--                     <div class="has-error"> -->
<%--                         <form:errors path="piso" class="help-inline"/> --%>
...
<!--         <div class="row"> -->
<!--             <div class="form-group col-md-12"> -->
<!--                 <label class="col-md-3 control-lable" for="departamento">Piso</label> -->
<!--                 <div class="col-md-7"> -->
<%--                     <form:input type="text" path="departamento" id="departamento" class="form-control input-sm" /> --%>
<!--                     <div class="has-error"> -->
<%--                         <form:errors path="departamento" class="help-inline"/> --%>
...
<!-- 			<div class="row"> -->
<!--             <div class="form-group col-md-12"> -->
<!--                 <label class="col-md-3 control-lable" for="codigoPostal">Telefono</label> -->
<!--                 <div class="col-md-7"> -->
<%--                     <form:input type="text" path="codigoPostal" id="codigoPostal" class="form-control input-sm" /> --%>
<!--                     <div class="has-error"> -->
<%--                         <form:errors path="codigoPostal" class="help-inline"/> --%>
...
<!--         <div class="row"> -->
<!--             <div class="form-group col-md-12"> -->
<!--                 <label class="col-md-3 control-lable" for="codigoPostal">Mail</label> -->
<!--                 <div class="col-md-7"> -->
<%--                     <form:input type="text" path="codigoPostal" id="codigoPostal" class="form-control input-sm" /> --%>
<!--                     <div class="has-error"> -->
<%--                         <form:errors path="codigoPostal" class="help-inline"/> --%>
